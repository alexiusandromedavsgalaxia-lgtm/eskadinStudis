...
function Account(){const t=useTranslation();return <main className="page narrow"><div className="eyebrow">{t.account}</div><h1 className="page-title">Player profile.</h1><div className="form-card"><div className="account-avatar">ES</div><h2>Eskådin Player</h2><p className="muted">0 published games · 0 sessions · 0 F¢</p><Link className="button button-ghost" to="/">{t.back}</Link></div></main>}
