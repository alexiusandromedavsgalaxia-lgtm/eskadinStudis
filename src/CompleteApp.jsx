...
function useLang(){const{lang}=useContext(LangContext);return[lang,{...TXT[lang],...EXTRA_T[lang],...UI_T[lang]}]}
...
function NotFound(){return <main className="page notfound"><h1>404</h1><p>{t.pageEscaped}</p><Link className="button button-primary" to="/">{t.home}</Link></main>}
