...
function AvatarEditor(){
 ...
 return <main className="roblox-page avatar-editor-page">
  ...
  <div className="avatar-editor-layout">
   <section className="roblox-card avatar-dressing-room"><div className="avatar-stage"><Avatar user={form} size="xl"/></div><div className="avatar-editor-actions"><button className="button button-primary" onClick={saveProfile}>Guardar avatar</button><Link className="button button-ghost" to="/account">Ver perfil</Link></div></section>
